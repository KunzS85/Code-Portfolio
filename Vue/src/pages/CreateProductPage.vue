    ...
    <template #default>
      <div class="row">
        <div class="col-12">
          <h1 class="mt-4">
            Neuer Artikel
            <button class="btn bt-lg bg-vue float-end" @click="createProduct">Speichern</button>
          </h1>
          <div class="card mt-4">
    ...
    return {
      product: {
        ...
        description: `Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                      Quisquam inventore totam soluta, sunt error cupiditate
                      minus voluptatum placeat ratione officia sint sit dolorem
                      quis reprehenderit odit esse animi nostrum ipsa.`,
